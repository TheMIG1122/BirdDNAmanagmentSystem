	...
	<div class="scroll-sidebar">
		<nav class="sidebar-nav">
			<ul id="sidebarnav">
                ...
                <!-- <li class="sidebar-item"> <a class="sidebar-link waves-effect waves-dark sidebar-link" href="index.php?page=rejected_samples" aria-expanded="false"><i class="flaticon-approval"></i><span class="hide-menu">Rejected Samples</span></a></li> -->
