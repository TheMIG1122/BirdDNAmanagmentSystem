  ...
  <div class=" ">
    <div class=" ">
        <div class="col-md-12 col-xl-12">
            <div class="card p-2">
                <div class="card-body">
                    <p><b>Total Amount </b>: <?php  echo calculate_total_amount("WHERE payment_status = 'Credit'");?> Rs <b>Total QTY</b> : <?php echo count_total('owners',"WHERE payment_status = 'Credit'","quantity");?> Samples</p>
